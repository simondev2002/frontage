...
enum SectionCatalog {
    ...
    static let variants: [String: [String]] = ["hero": ["split", "centered", "fullbleed", "editorial", "minimal"], "about": ["text", "imageLeft", "imageRight", "stats"], "services": ["cards", "list", "grid"], "gallery": ["grid", "masonry", "strip"], "testimonials": ["cards", "single", "wall"], "features": ["grid", "checklist", "columns"], "contact": ["split", "stacked"], "cta": ["banner", "card"]]
    /// Layout names as owners read them; the raw values stay in the spec.
    static let variantLabels: [String: String] = ["split": "Text beside photo", "centered": "Centered", "fullbleed": "Full-width photo", "editorial": "Editorial", "minimal": "Minimal", "text": "Text only", "imageLeft": "Photo on the left", "imageRight": "Photo on the right", "stats": "With key numbers", "cards": "Cards", "list": "List", "grid": "Grid", "masonry": "Masonry", "strip": "Photo strip", "single": "One at a time", "wall": "Wall", "checklist": "Checklist", "columns": "Columns", "stacked": "Stacked", "banner": "Banner", "card": "Card"]
    ...
    static func template(_ type: String) -> [String: JSONValue] {
        ...
        case "menu": return ["heading": s("Menu"), "intro": .null, "categories": .array([.object(["name": s("Starters"), "items": .array([.object(["name": s(""), "description": .null, "price": s("")])])])])]
        ...
        case "faq": return ["heading": s("Questions"), "items": .array([.object(["question": s(""), "answer": s("")])])]
